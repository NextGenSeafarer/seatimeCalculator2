...
class SeatimecalculatorCounterLogicTest {
    ...
    void oneDayTest() {
        for (int i = 0; i < 150; i++) {
            ...
            assertEquals( "0:0:1",seaTimeCountingLogic.test(sign_on, sign_off));
        }
    }
...
//    }
    ...
    void randomDatesTest2(){
        ...
        assertEquals(seaTimeCountingLogic.test(sign_on,sign_off),"0:7:6");
    }
    ...
    void randomDatesTest4(){
        ...
        assertEquals(seaTimeCountingLogic.test(sign_on,sign_off),"0:3:28");
    }
    @Test
